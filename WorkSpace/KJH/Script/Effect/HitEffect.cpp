...
void HitEffect::SetAnimePosition(const Vector2& position)
{
	for (size_t i = 0; i < 9; i++)
	{
		AnimeList[i]->GetTransform().SetPosition(position.x, position.y);
	}
}

void HitEffect::CallAnime(int num , const Vector2& position)
{
