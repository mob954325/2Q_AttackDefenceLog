...
void CloudManager::OnStart()
{
	...
	std::wstring files[] =
	{ L"cloud1.png", L"cloud2.png", L"cloud3.png", L"cloud4.png" };
...
void CloudManager::Reset()
{
	...
	p1.startTimingAlpha = 0.0f;			p1.targetTimingAlpha = 0.6f;

	//[2]===============================================================
	//구름 왼쪽 아래
	auto& p2 = effectProgress[2];
	p2.startPos = { 100.0f,100.0f };	p2.targetPos = { 0.0f,0.0f };
	p2.startTimingPos = 0.0f;			p2.targetTimingPos = 0.9f;
	p2.startTimingAlpha = 0.0f;			p2.targetTimingAlpha = 0.6f;

	//[3]===============================================================
	//구름 오른쪽 위
	auto& p3 = effectProgress[3];
	p3.startPos = { 100.0f,100.0f };	p3.targetPos = { 0.0f,0.0f };
	p3.startTimingPos = 0.0f;			p3.targetTimingPos = 0.9f;
	p3.startTimingAlpha = 0.0f;			p3.targetTimingAlpha = 0.6f;
