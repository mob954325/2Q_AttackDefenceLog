...
void SlicedObject::OnStart()
{
}

void SlicedObject::OnDestroy()
{
}

void SlicedObject::OnUpdate()
{
...
void SlicedObject::OnFixedUpdate()
{
}

bool SlicedObject::IsOverlap(float x, float y)
{
...
void SlicedObject::HandleOverlap()
{
...
Vector2 SlicedObject::ClampPoisiton(const Vector2& vec)
{
